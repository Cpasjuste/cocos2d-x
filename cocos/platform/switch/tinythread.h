...
class mutex {
  public:
    ...
    inline bool try_lock()
    {
      ...
      return ret;
#elif _TTHREAD_SWITCH_
        return mtx_trylock(&mHandle) == thrd_success;
#else
...
class recursive_mutex {
  public:
    ...
    recursive_mutex()
    {
      ...
      InitializeCriticalSection(&mHandle);
#elif _TTHREAD_SWITCH_
      mtx_init(&mHandle, mtx_plain | mtx_recursive);
#else
...
class condition_variable {
  public:
    ...
    inline void wait(_mutexT &aMutex)
    {
      ...
      aMutex.lock();
#elif _TTHREAD_SWITCH_
      cnd_wait(&mHandle, &aMutex.mHandle);
#else
...
#elif _TTHREAD_SWITCH_
    u64 nano = u64(double(aTime.count()) * (1000000.0 * _Period::_as_double()) + 0.5) * 1000;
    svcSleepThread(nano);
#else
